...
private:
    ...
    const std::string prompt_instructions = "Identify whether the given sentences are greetings, compliments, insults, questions, requests, or statements. Rude language does not automatically make something an insult. \
        Use only a single word from this list: insult, question, greeting, compliment, request, statement. Note that requests and questions are similar, but questions that are asking to do a specific task should be considered requests.\n\n\
