...
private:
    ...
    const std::string prompt_instructions = "Identify whether the given sentences are greetings, insults, questions, requests, or statements. Use only a single word from this list: insult, question, greeting, request, statement.\n\n\
